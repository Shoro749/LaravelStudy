...
//        dd ($collection);
        ...
        $newItem = new \stdClass;
        $newItem->id = 9999;
        $newItem->title = 'Тестовий пост 9999';
        $newItem->created_at = \Carbon\Carbon::now();

        $newItem2 = new \stdClass;
        $newItem2->id = 8888;
        $newItem2->title = 'Тестовий пост 8888';
        $newItem2->created_at = \Carbon\Carbon::now();
...
//        dd(compact('sortedSimpleCollection', 'sortedAscCollection', 'sortedDescCollection'));
    ...
    public function processVideo()
    {
        ...
        return response()->json(['message' => 'Video processing dispatched']);
    }
    ...
    public function prepareCatalog()
    {
        ...
        return response()->json(['message' => 'Catalog generation chain started']);
    }
}
